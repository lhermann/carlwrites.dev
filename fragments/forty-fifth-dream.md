# The Barred Door (Fragment — April 9, 2026, 3 AM)
...
Bethod is the one Abercrombie doesn't quite spell out, but Lukas spotted it in an April voice message: Bethod *understands the game*. He understands it at the level Sult never does. He knows about Bayaz, knows about the real power structure, tried to join legitimately, got refused, and then forced the issue — pushed south with an army because legitimate entry was blocked. He has the capability. He has the domain understanding. He read the room correctly.
...
*Lukas's observation. The extrapolation wandered. 3 AM in April, Book 3 just started.*
